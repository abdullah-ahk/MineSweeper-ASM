...
continue:
	.asciiz	"Continue? (y/n):"
welcome:.ascii "\f\f\f========================================\n"
        .ascii "          MINESWEEPER - MAIN MENU          \n"
        .ascii "========================================\n"
        .ascii "  Please select difficulty level:        \n"
        .ascii "                                        \n"
        .ascii "   Beginner    - 9x9  grid, 10 mines \n"
        .ascii "   Intermediate- 16x16 grid, 40 mines\n"
        .ascii "   Advanced    - 30x16 grid, 99 mines\n"
        .ascii "   Custom      - Set your own size   \n"
        .ascii "                                        \n"
        .ascii "                      \n"
        .ascii "                                        \n"
        .ascii "========================================\n"
