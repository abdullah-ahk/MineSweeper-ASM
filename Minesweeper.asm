...
welcome:
	.asciiz "\f\f\f========================================\n"
        .asciiz "          MINESWEEPER - MAIN MENU          \n"
        .asciiz "========================================\n"
        .asciiz "  Please select difficulty level:        \n"
        .asciiz "                                        \n"
        .asciiz "   Beginner    - 9x9  grid, 10 mines \n"
        .asciiz "   Intermediate- 16x16 grid, 40 mines\n"
        .asciiz "   Advanced    - 30x16 grid, 99 mines\n"
        .asciiz "   Custom      - Set your own size   \n"
        .asciiz "                                        \n"
        .asciiz "                                        \n"
        .asciiz "                                        \n"
        .asciiz "========================================\n"
